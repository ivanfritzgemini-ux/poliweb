...
"[project]/src/ai/flows/generate-student-avatar.ts [app-rsc] (ecmascript)", ((__turbopack_context__) => {
"use strict";

// This file is machine-generated - edit at your own risk!
/* __next_internal_action_entry_do_not_use__ [{"4098b9775ec9bd9824f5c964b95f00829bc7253b6b":"generateStudentAvatar"},"",""] */ __turbopack_context__.s([
...
;
;
const GenerateStudentAvatarInputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    studentName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().describe('The name of the student.')
});
const GenerateStudentAvatarOutputSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    avatarDataUri: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$genkit$2f$lib$2f$common$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().describe('The generated avatar for the student, as a data URI that must include a MIME type and use Base64 encoding. Expected format: \'data:<mimetype>;base64,<encoded_data>\'.' // keep this comment here to avoid reformatting
    )
});
async function generateStudentAvatar(input) {
    return generateStudentAvatarFlow(input);
}
const generateStudentAvatarPrompt = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].definePrompt({
    name: 'generateStudentAvatarPrompt',
    input: {
        schema: GenerateStudentAvatarInputSchema
    },
    output: {
        schema: GenerateStudentAvatarOutputSchema
    },
...
const generateStudentAvatarFlow = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$genkit$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ai"].defineFlow({
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(generateStudentAvatar, "4098b9775ec9bd9824f5c964b95f00829bc7253b6b", null);
}),
...
/* __next_internal_action_entry_do_not_use__ [{"0009c048a3bd6aa52d0b25e31c4d73d5b53082487f":"getSexos","0019014b60c42d5b6e2ab997e98c0c7c9fa2392eb5":"getRoles","001caa51f19e6476b6e551c8dc978110694224d596":"getStudents","002661833dc8c035414bc276704ea4a84e01f98c9e":"getStaff","003b2eeb44f52ef0e5bacd2292a025606f38a09047":"getCourses","400f737a1a15becc89d8fa1f1b6f5a9806c8fa8fb3":"generateAvatarAction","407f7da717f73806b1cc158e584114ac5d985bd882":"getStaffByRut","40e13c3d111a3339b1a932c31b2deb94cb1bcd10a2":"addStaff","707fa67a4333fe3439bfe95bf6f7b23ba685a2a53f":"updateStaff"},"",""] */ __turbopack_context__.s([
    "addStaff",
    ()=>addStaff,
...
;
;
async function generateAvatarAction(input) {
    try {
        const output = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$ai$2f$flows$2f$generate$2d$student$2d$avatar$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateStudentAvatar"])(input);
        return {
            avatarDataUri: output.avatarDataUri
        };
    } catch (e) {
        console.error(e);
        return {
...
async function getStaff() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('id, rut, nombres, apellidos, email, status, sexo(id, nombre), role:roles(id, nombre_rol)');
    if (error) {
...
async function getStudents() {
    const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["supabase"].from('estudiantes_detalles').select('*');
    if (error) {
...
async function getCourses() {
    ...
    return data.map((curso)=>({
            id: String(curso.id),
            nombre: `${curso.nivel} ${curso.letra}`
        }));
}
;
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$action$2d$validate$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["ensureServerEntryExports"])([
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(updateStaff, "707fa67a4333fe3439bfe95bf6f7b23ba685a2a53f", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getStaffByRut, "407f7da717f73806b1cc158e584114ac5d985bd882", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getStudents, "001caa51f19e6476b6e551c8dc978110694224d596", null);
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getCourses, "003b2eeb44f52ef0e5bacd2292a025606f38a09047", null);
}),
...
__turbopack_context__.s([
    ...
    "001caa51f19e6476b6e551c8dc978110694224d596",
    ...
    "003b2eeb44f52ef0e5bacd2292a025606f38a09047",
    ...
    "400f737a1a15becc89d8fa1f1b6f5a9806c8fa8fb3",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$actions$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["generateAvatarAction"],
    "407f7da717f73806b1cc158e584114ac5d985bd882",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__334f6b15._.js.map