...
function LoginPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            const { data: profile, error: profileError } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["supabase"].from('usuarios').select('id, nombres, apellidos, email, role:roles(id, nombre_rol)').eq('id', userId).single();
            if (profileError) {
            ...
            toast({
                title: 'Bienvenido',
                description: `Hola ${profile.nombres} ${profile.apellidos}`
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99f49b6e._.js.map