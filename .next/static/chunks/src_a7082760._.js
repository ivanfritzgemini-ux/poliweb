...
function AddStaffForm(param) {
    ...
    function onSubmit(values) {
        const newStaffMember = {
            id: "STF-".concat(String(Math.floor(Math.random() * 900) + 100).padStart(3, '0')),
            ...values,
            status: 'active'
        };
        ...
        toast({
            ...
            description: "".concat(values.name, " ha sido añadido al sistema.")
        });
        form.reset();
    }
...
//# sourceMappingURL=src_a7082760._.js.map