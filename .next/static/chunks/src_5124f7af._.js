...
"[project]/src/lib/data:2e5282 [app-client] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2e5282__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/lib/data:2e5282 [app-client] (ecmascript) <text/javascript>");
...
function EnrollStudentForm(param) {
    ...
    const handleSearchByRut = async ()=>{
        ...
        try {
            ...
            if (person) {
                const existingStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2e5282__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getStudentByRut"])(rut);
                if (existingStudent) {
                    form.setError('rut', {
                        type: 'manual',
    ...
    async function onSubmit(values) {
        ...
        try {
            var _courses_find;
            const existingStudent = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$3a$2e5282__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["getStudentByRut"])(values.rut);
            if (existingStudent) {
                form.setError('rut', {
                    type: 'manual',
                    message: 'Este RUT ya corresponde a un estudiante matriculado.'
...
//# sourceMappingURL=src_5124f7af._.js.map