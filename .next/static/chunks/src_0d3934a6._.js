...
function EnrollStudentForm(param) {
    ...
    async function onSubmit(values) {
        ...
        try {
            ...
            const newStudent = {
                id: "STU-".concat(String(Math.floor(Math.random() * 900) + 100).padStart(3, '0')),
                ...values,
            ...
            toast({
                ...
                description: "".concat(values.name, " ha sido añadido exitosamente.")
            });
            form.reset();
        } catch (error) {
            toast({
...
_s(EnrollStudentForm, "3BlcuXlwSTiKqal0RpeuxdEEkIw=", false, function() {
    return [
...
function StudentList() {
    ...
    const filteredStudents = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StudentList.useMemo[filteredStudents]": ()=>students.filter({
                "StudentList.useMemo[filteredStudents]": (student)=>student.name.toLowerCase().includes(searchTerm.toLowerCase()) || student.id.toLowerCase().includes(searchTerm.toLowerCase()) || student.grade.toLowerCase().includes(searchTerm.toLowerCase())
...
//# sourceMappingURL=src_0d3934a6._.js.map