...
function StaffList() {
    _s();
    const [staff, setStaff] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(MOCK_STAFF);
    ...
    const filteredStaff = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "StaffList.useMemo[filteredStaff]": ()=>staff.filter({
                "StaffList.useMemo[filteredStaff]": (person)=>person.name.toLowerCase().includes(searchTerm.toLowerCase()) || person.email.toLowerCase().includes(searchTerm.toLowerCase())
...
_s(StaffList, "XS73N7LTXAlFYar58FIeChwOfQE=");
_c = StaffList;
var _c;
...
//# sourceMappingURL=src_components_e4e76717._.js.map