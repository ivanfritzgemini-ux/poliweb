...
function EnrollStudentForm(param) {
    ...
    const handleSearchByRut = async ()=>{
        ...
        try {
            ...
            if (person) {
                form.setValue('name', "".concat(person.nombres, " ").concat(person.apellidos));
...
_s(EnrollStudentForm, "rsa174h4PS3gLtkL0sh8YdhVBJ0=", false, function() {
    return [
...
//# sourceMappingURL=src_3a15f648._.js.map